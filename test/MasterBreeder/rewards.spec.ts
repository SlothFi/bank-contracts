...
describe('MasterBreeder::Rewards', () => {
  ...
  context("Entering & withdrawing from pools + claiming rewards", function () {
    ...
    it("should not pay out SLOTH rewards before farming has started", async function () {
      // 1 SLOTH per block farming rate starting at block 100 with the first halvening block starting 1000 blocks after the start block
    ...
    it("should pay out SLOTH rewards after farming has started", async function () {
      this.timeout(0)
    ...
    it("should not distribute SLOTHs if no one deposit", async function () {
      this.timeout(0)
      const debugMessages = false
    ...
    it("should distribute SLOTHs properly for each staker"), async () => {
    ...
    it("should give proper SLOTHs allocation to each pool"), async () => {
